...
class CDk(nn.Module):
    """
    This class is used to create a convolutional layer for Discriminator.
    """
    ...
    def __init__(self, in_features, out_features, is_leaky=False):
        ...
        :param is_leaky: apply leaky relu or not
        """
        ...
        # applying another convolutional layer without scaling the depth
...
class Ck(nn.Module):
    """
    This class is used to create a convolutional layer for Generator.
    """
    ...
    def __init__(self, in_features, out_features, is_leaky=False, batch_norm=True):
        ...
        :param is_leaky:  apply leaky relu or not
        :param batch_norm:  apply batch normalization or not
        """
...
class Upsample(nn.Module):
    """
    This class is used to create an upsampling layer for Generator.
    """
...
class Generator(nn.Module):
    """
    This class is used to create a generator model.
    """
...
class Discriminator(nn.Module):
    """
    This class is used to create a discriminator model.
    """

    __slots__ = ['conv_color', 'conv_mono', 'conv2', 'conv3', 'conv4', 'pooling', 'conv6', 'final']
    ...
    def forward(self, x_color, x_mono):
        """
        This function is used to forward propagate the input.
        :param x_color: color image
        :param x_mono: monochrome image
        :return:  final output
        """
